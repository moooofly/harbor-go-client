...
type recentLogs struct {
	...
	Operation      string `short:"o" long:"operation" description:"The operation."`
	BeginTimestamp string `short:"b" long:"begin_timestamp" description:"The begin timestamp."`
	EndTimestamp   string `short:"e" long:"end_timestamp" description:"The end timestamp."`
